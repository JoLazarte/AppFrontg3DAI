...
export default function Registrarse({ navigation}){
    ...
    const handleNavigateToRegistrarseUsuario = () => {
        navigation.navigate('RegistrarseUsuario');
    }

    const handleNavigateToRegistrarseEstudiante = () => {
        navigation.navigate('RegistrarseEstudiante');
    }
    ...
    return(
        <View style={styles.container}>
            ...
            ]} onPress={handleNavigateToRegistrarseUsuario}>
                <Text style={styles.botonesTexto}>Usuario</Text>
            </Pressable>
            <Pressable style={({pressed}) => [
                styles.botones,
                pressed && styles.botonesPressed
            ]} onPress={handleNavigateToRegistrarseEstudiante}>
                <Text style={styles.botonesTexto}>Estudiante</Text>
            </Pressable>
        </View>
    )
}
